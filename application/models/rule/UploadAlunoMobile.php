...
class Model_Rule_UploadAlunoMobile extends Zend_File_Transfer_Adapter_Http {
    
    const DIR_IMAGE     = '/../public_html/images/fotos/';
    const DIR_THUMBNAIL = '/../public_html/images/fotos/thumbnail/';
